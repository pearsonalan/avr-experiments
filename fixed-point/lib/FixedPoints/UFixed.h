...
public:
	...
	static constexpr UFixed Epsilon() { return fromInternal(1); }
	static constexpr UFixed MinValue() { return fromInternal(0); }
	static constexpr UFixed MaxValue() { return fromInternal(~0); }
